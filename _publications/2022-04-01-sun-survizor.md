...
|   |   |
|---|---|
| <img src="/images/CompoVis.png" alt="Thumbnail" style="width: 300px; height: auto;">    |  **CompoVis: Is Cross-modal Semantic Alignment of CLIP Optimal? A Visual Analysis Attempt**<br>**Tong Li**, Guodao Sun*, Xueqian Zheng, Qi Jiang, Wang Xia, Xu Tan, Haidong Gao, Jingwei Tang, Yunchao Wang, Haixia Wang & Ronghua Liang. <br>**IEEE TMM**. in submission.<br>[**[Dataset]**](https://huggingface.co/datasets/guodaosun/CompoVIS) [**[Algorithm]**](https://github.com/TongLi97/HERCSOM-layout) 
